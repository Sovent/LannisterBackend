...
namespace LannisterAPI.Models
{
    ...
    {
        public ProfileOwnerProfile(string userId, string name, string nickname, Uri avatar, DateTimeOffset registrationDate, double totalDebtAmount, CurrencySettings currencySettings, NotificationSettings notificationSettings)
        {
            UserId = userId;
            Name = name;
            Nickname = nickname;
        ...
        [Required] public bool IsProfileOwner => true;
        [Required] public string Name { get; }
        [Required] public string Nickname { get; }
        [Required] public Uri Avatar { get; }
        [Required] public DateTimeOffset RegistrationDate { get; }
        [Required] public double TotalDebtAmount { get; }
        [Required] public CurrencySettings CurrencySettings { get; }
        [Required] public NotificationSettings NotificationSettings { get; }
    }
    ...
    public class CurrencySettings
    {
        ...
        [Required] public string DefaultCurrencyCode { get; }
        [Required] public CustomCurrencyRate[] CustomCurrencyRates { get; }
    }
    ...
    public class UserProfile
    {
        ...
        [Required] public string UserId { get; }
        [Required] public bool IsProfileOwner => false;
        [Required] public string Name { get; }
        [Required] public string Nickname { get; }
        [Required] public Uri Avatar { get; }
        [Required] public UserProfileDebtsPreview[] Debts { get; }
    }
