...
namespace LannisterAPI.Models
{
    public class UserDebtPreview
    {
        ...
        [Required] public double DebtAmount { get; }
    }
    ...
    public class UserDebtPreviewsList
    {
        ...
        [Required] public string UserId { get; }
        [Required] public UserDebtPreview[] Debts { get; }
    }
    ...
    public class TrackingDebts
    {
        ...
        [Required] public TrackingDebt[] Debts { get; }
    }
    ...
    public class TrackingDebt
    {
        ...
        [Required] public TrackingDebtOwner DebtObject { get; }
        [Required] public TrackingDebtOwner DebtSubject { get; }
        [Required] [Range(0.01, Double.MaxValue)] public double Amount { get; }
