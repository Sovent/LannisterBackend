...
namespace LannisterAPI.Models
{
  ...
  {
    public TrackingPreview(string id, string name, float currentBalance, int personsCount, string currencyCode,
      bool isEnabled)
    {
      Id = id;
      Name = name;
  ...
  public class TrackingList
  {
    ...
    [Required]
    public TrackingPreview[] Trackings { get; }
  }

  public class Tracking
  {
    public Tracking(string id, string name, string currencyCode, TrackingParticipant[] participants, string creatorId,
      DateTimeOffset creationDate, DateTimeOffset? closedDate)
    {
      Id = id;
      Name = name;
      CurrencyCode = currencyCode;
    ...
    [Required]
    public TrackingParticipant[] Participants { get; }
  ...
  public class TrackingParticipant
  {
    ...
    [Required]
    public bool AcceptedInvite { get; }
  }
